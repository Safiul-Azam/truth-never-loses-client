...
const services = [
    ...
    { id: 1, name: 'Immigration', price: 750, description: 'An immigration lawyer helps you with all the gritty processes that come with immigration, making the entire experience more convenient and hassle-free.', img: services2 },
    { id: 1, name: 'Criminal', price: 570, description: 'Life as a criminal defense lawyer is tough; there are a lot of highs and lows, but it’s completely worth it in the end. Here is what it’s like to be a criminal defense lawyer.', img: services3 },
]
